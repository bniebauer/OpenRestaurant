...
class MenuTableViewController: UITableViewController {
    ...
    func configure(_ cell: UITableViewCell, forItemAt indexPath: IndexPath) {
        ...
        cell.detailTextLabel?.text = FormatterController.shared.getStringFormatFor(price: menuItem.price)
    }
    
    // MARK: - Segue Method
    
    @IBSegueAction func showDetail(_ coder: NSCoder, sender: Any?) -> MenuItemDetailViewController? {
